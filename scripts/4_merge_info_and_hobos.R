...
#load in files
info <- read_csv("data/processed_data/logger_history.csv")
hobo <- read_csv("data/processed_data/combined_hobo_data.csv") %>%
  filter(temp_c < 22) #this is preposterous - likely instrument noise (72F)
...
#write
write_csv(hobo_joined_trimmed, "data/processed_data/merged_hobo_data_with_sites.csv")
